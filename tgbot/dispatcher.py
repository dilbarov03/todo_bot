...
from tgbot.handlers.tasks import handlers as task_handlers
...
def setup_dispatcher(dp):
    ...
    # admin commands
    dp.add_handler(CommandHandler("todo", task_handlers.tasks_start))
    ...
    dp.add_handler(MessageHandler(
      Filters.text & ~Filters.command, task_handlers.set_name))
    ...
    #tasks
    dp.add_handler(
        CallbackQueryHandler(task_handlers.calback_handler)
    )
